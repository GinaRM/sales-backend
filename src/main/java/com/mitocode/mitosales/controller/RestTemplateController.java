...
import com.mitocode.mitosales.security.JwtRequest;
import com.mitocode.mitosales.security.JwtResponse;
...
public class RestTemplateController {
    ...
    public ResponseEntity<Void> test8(@PathVariable("id") Integer id) throws Exception{
        ...
        JwtRequest userRequest = new JwtRequest("Gina", "123");
        ...
        //send token to ask for data or do some actions
        ...
        String url = "http://localhost:8080/categories/{idCatecory}";

        Map<String, Integer> uriVariables = new HashMap<>();
        uriVariables.put("idCategory", id);

        restTemplate.delete(url, HttpMethod.DELETE, jwtEntity, String.class, uriVariables);
